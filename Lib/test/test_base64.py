...
class BaseXYTestCase(unittest.TestCase):
    ...
    def test_b64encode_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertTrue(any('base64.b64encode returns bytes in Python 3 (str in 2.x)' in str(x.message) for x in w))
    ...
    def test_b32encode_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertTrue(any('base64.b32encode returns bytes in Python 3 (str in 2.x)' in str(x.message) for x in w))
    ...
    def test_b16encode_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertTrue(any('base64.b16encode returns bytes in Python 3 (str in 2.x)' in str(x.message) for x in w))
    ...
    def test_encodebytes_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            self.assertTrue(any('base64.encodebytes returns bytes in Python 3 (str in 2.x)' in str(x.message) for x in w))
